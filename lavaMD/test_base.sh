#/bin/bash
TARGET=lavaMD
../bin/split_kernel $TARGET.base.exe
...
LD_LIBRARY_PATH=/home/wuxx1279/bin/dyninst/lib:$LD_LIBRARY_PATH DYNINST_DEBUG_PARSING=1 OMP_NUM_THREADS=1 ../bin/updated_base tmp_00.hsaco config.ini
