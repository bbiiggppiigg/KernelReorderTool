...
std::map<const void * , char *> FuncLookup;
...
extern "C" void __hipRegisterFunction(
    ...
    FuncLookup[hostFunction]=deviceFunction;
    return;
}
        ...
        hipStream_t stream)
{
    ...
    printf("hip Launch Kernel Called, hostFunction = %p, name = %s , stream = %u\n",hostFunction,FuncLookup[hostFunction],stream);
