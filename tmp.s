...
00000000000013e8 BB0_19:
	...
	s_and_b32 s2, s1, -8                                       // 0000000013F8: 8602C801
...
0000000000001428 BB0_21:
	s_branch 218                                               // 000000001428: BF8200DA <BB0_26+0x148>
	v_cndmask_b32_e32 v1, 2, v5, vcc                           // 00000000142C: 00020A82
...
000000000000164c BB0_26:
	...
	s_branch 137                                               // 000000001748: BF820089 <BB0_26+0x324>
	...
	v_lshlrev_b64 v[7:8], 2, v[5:6]                            // 0000000017A4: D28F0007 00020A82
	v_add_u32_e32 v9, s1, v5                                   // 0000000017AC: 68120A01
	v_mov_b32_e32 v10, v6                                      // 0000000017B0: 7E140306
	v_mov_b32_e32 v19, s17                                     // 0000000017B4: 7E260211
	v_add_co_u32_e32 v7, vcc, s16, v7                          // 0000000017B8: 320E0E10
	v_lshlrev_b64 v[9:10], 2, v[9:10]                          // 0000000017BC: D28F0009 00021282
	v_addc_co_u32_e32 v8, vcc, v19, v8, vcc                    // 0000000017C4: 38101113
	v_add_u32_e32 v11, s5, v5                                  // 0000000017C8: 68160A05
	v_mov_b32_e32 v12, v6                                      // 0000000017CC: 7E180306
	v_mov_b32_e32 v20, s17                                     // 0000000017D0: 7E280211
	v_add_co_u32_e32 v9, vcc, s16, v9                          // 0000000017D4: 32121210
	v_lshlrev_b64 v[11:12], 2, v[11:12]                        // 0000000017D8: D28F000B 00021682
	v_addc_co_u32_e32 v10, vcc, v20, v10, vcc                  // 0000000017E0: 38141514
	v_add_u32_e32 v13, s7, v5                                  // 0000000017E4: 681A0A07
	v_mov_b32_e32 v14, v6                                      // 0000000017E8: 7E1C0306
	v_mov_b32_e32 v21, s17                                     // 0000000017EC: 7E2A0211
	v_add_co_u32_e32 v11, vcc, s16, v11                        // 0000000017F0: 32161610
	v_lshlrev_b64 v[13:14], 2, v[13:14]                        // 0000000017F4: D28F000D 00021A82
	v_addc_co_u32_e32 v12, vcc, v21, v12, vcc                  // 0000000017FC: 38181915
	v_add_u32_e32 v15, s10, v5                                 // 000000001800: 681E0A0A
	v_mov_b32_e32 v16, v6                                      // 000000001804: 7E200306
	v_mov_b32_e32 v22, s17                                     // 000000001808: 7E2C0211
	v_add_co_u32_e32 v13, vcc, s16, v13                        // 00000000180C: 321A1A10
	v_lshlrev_b64 v[15:16], 2, v[15:16]                        // 000000001810: D28F000F 00021E82
	v_addc_co_u32_e32 v14, vcc, v22, v14, vcc                  // 000000001818: 381C1D16
	v_add_u32_e32 v17, s11, v5                                 // 00000000181C: 68220A0B
	v_mov_b32_e32 v18, v6                                      // 000000001820: 7E240306
	v_mov_b32_e32 v23, s17                                     // 000000001824: 7E2E0211
	v_add_co_u32_e32 v15, vcc, s16, v15                        // 000000001828: 321E1E10
	v_lshlrev_b64 v[17:18], 2, v[17:18]                        // 00000000182C: D28F0011 00022282
	v_addc_co_u32_e32 v16, vcc, v23, v16, vcc                  // 000000001834: 38202117
	v_add_u32_e32 v19, s14, v5                                 // 000000001838: 68260A0E
	v_mov_b32_e32 v20, v6                                      // 00000000183C: 7E280306
	v_mov_b32_e32 v24, s17                                     // 000000001840: 7E300211
	v_add_co_u32_e32 v17, vcc, s16, v17                        // 000000001844: 32222210
	v_lshlrev_b64 v[19:20], 2, v[19:20]                        // 000000001848: D28F0013 00022682
	v_addc_co_u32_e32 v18, vcc, v24, v18, vcc                  // 000000001850: 38242518
	v_add_u32_e32 v21, s15, v5                                 // 000000001854: 682A0A0F
	v_mov_b32_e32 v22, v6                                      // 000000001858: 7E2C0306
	v_mov_b32_e32 v25, s17                                     // 00000000185C: 7E320211
	v_add_co_u32_e32 v19, vcc, s16, v19                        // 000000001860: 32262610
	v_lshlrev_b64 v[21:22], 2, v[21:22]                        // 000000001864: D28F0015 00022A82
	v_addc_co_u32_e32 v20, vcc, v25, v20, vcc                  // 00000000186C: 38282919
	v_add_co_u32_e32 v21, vcc, s16, v21                        // 000000001870: 322A2A10
	v_addc_co_u32_e32 v22, vcc, v23, v22, vcc                  // 000000001874: 382C2D17
	global_load_dword v23, v[7:8], off                         // 000000001878: DC508000 177F0007
	global_load_dword v24, v[9:10], off                        // 000000001880: DC508000 187F0009
	global_load_dword v25, v[11:12], off                       // 000000001888: DC508000 197F000B
	global_load_dword v26, v[13:14], off                       // 000000001890: DC508000 1A7F000D
	global_load_dword v27, v[15:16], off                       // 000000001898: DC508000 1B7F000F
	global_load_dword v28, v[17:18], off                       // 0000000018A0: DC508000 1C7F0011
	global_load_dword v29, v[19:20], off                       // 0000000018A8: DC508000 1D7F0013
	global_load_dword v30, v[21:22], off                       // 0000000018B0: DC508000 1E7F0015
	ds_read2_b32 v[7:8], v4 offset1:1                          // 0000000018B8: D86E0100 07000004
	ds_read2_b32 v[9:10], v4 offset0:2 offset1:3               // 0000000018C0: D86E0302 09000004
	ds_read2_b32 v[11:12], v4 offset0:4 offset1:5              // 0000000018C8: D86E0504 0B000004
	ds_read2_b32 v[13:14], v4 offset0:6 offset1:7              // 0000000018D0: D86E0706 0D000004
	s_add_i32 s18, s18, 8                                      // 0000000018D8: 81128812
	v_add_u32_e32 v5, s4, v5                                   // 0000000018DC: 680A0A04
	v_add_u32_e32 v4, 32, v4                                   // 0000000018E0: 680808A0
	s_cmp_eq_u32 s2, s18                                       // 0000000018E4: BF061202
	s_waitcnt vmcnt(7) lgkmcnt(3)                              // 0000000018E8: BF8C0377
	v_fma_f32 v2, v7, v23, v2                                  // 0000000018EC: D1CB0002 040A2F07
	s_waitcnt vmcnt(6)                                         // 0000000018F4: BF8C0F76
	v_fma_f32 v2, v8, v24, v2                                  // 0000000018F8: D1CB0002 040A3108
	s_waitcnt vmcnt(5) lgkmcnt(2)                              // 000000001900: BF8C0275
	v_fma_f32 v2, v9, v25, v2                                  // 000000001904: D1CB0002 040A3309
	s_waitcnt vmcnt(4)                                         // 00000000190C: BF8C0F74
	v_fma_f32 v2, v10, v26, v2                                 // 000000001910: D1CB0002 040A350A
	s_waitcnt vmcnt(3) lgkmcnt(1)                              // 000000001918: BF8C0173
	v_fma_f32 v2, v11, v27, v2                                 // 00000000191C: D1CB0002 040A370B
	s_waitcnt vmcnt(2)                                         // 000000001924: BF8C0F72
	v_fma_f32 v2, v12, v28, v2                                 // 000000001928: D1CB0002 040A390C
	s_waitcnt vmcnt(1) lgkmcnt(0)                              // 000000001930: BF8C0071
	v_fma_f32 v2, v13, v29, v2                                 // 000000001934: D1CB0002 040A3B0D
	s_waitcnt vmcnt(0)                                         // 00000000193C: BF8C0F70
	v_fma_f32 v2, v14, v30, v2                                 // 000000001940: D1CB0002 040A3D0E
	s_mov_b64 s[32:33], src_scc                                // 000000001948: BEA001FD
	s_memtime s[30:31]                                         // 00000000194C: C0900780 00000000
	s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)                    // 000000001954: BF8C0000
	s_sub_u32 s28, s30, s28                                    // 000000001958: 809C1C1E
	s_subb_u32 s29, s31, s29                                   // 00000000195C: 829D1D1F
	s_add_u32 s34, s34, s28                                    // 000000001960: 80221C22
	s_addc_u32 s35, s35, s29                                   // 000000001964: 82231D23
	s_and_b32 s32, s32, s32                                    // 000000001968: 86202020
	s_branch 65303                                             // 00000000196C: BF82FF17 <BB0_21+0x1a4>
	s_waitcnt lgkmcnt(0)                                       // 000000001970: BF8CC07F
	s_mov_b64 s[32:33], src_scc                                // 000000001974: BEA001FD
	s_ashr_i32 s36, s36, 3                                     // 000000001978: 90248324
	s_mul_hi_u32 s37, s39, s36                                 // 00000000197C: 96252427
	s_mul_i32 s36, s39, s36                                    // 000000001980: 92242427
	s_add_u32 s36, s38, s36                                    // 000000001984: 80242426
	s_addc_u32 s37, 0, s37                                     // 000000001988: 82252580
	s_lshl_b64 s[36:37], s[36:37], 3                           // 00000000198C: 8EA48324
	s_add_u32 s26, s36, s26                                    // 000000001990: 801A1A24
	s_addc_u32 s27, s37, s27                                   // 000000001994: 821B1B25
	s_add_u32 s26, 0x3ff8, s26                                 // 000000001998: 801A1AFF 00003FF8
	s_addc_u32 s27, 0, s27                                     // 0000000019A0: 821B1B80
	s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)                    // 0000000019A4: BF8C0000
	s_add_u32 s26, 8, s26                                      // 0000000019A8: 801A1A88
	s_addc_u32 s27, 0, s27                                     // 0000000019AC: 821B1B80
	v_mov_b32_e32 v6, s26                                      // 0000000019B0: 7E0C021A
	v_mov_b32_e32 v7, s27                                      // 0000000019B4: 7E0E021B
	v_mov_b32_e32 v8, s34                                      // 0000000019B8: 7E100222
	v_mov_b32_e32 v9, s35                                      // 0000000019BC: 7E120223
	flat_store_dwordx2 v[6:7], v[8:9]                          // 0000000019C0: DC740000 00000806
	s_and_b32 s32, s32, s32                                    // 0000000019C8: 86202020
	s_branch 65375                                             // 0000000019CC: BF82FF5F <BB0_26+0x100>
		...
