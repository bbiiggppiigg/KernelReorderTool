...
void test_getreg(FILE * f, vector<bb> &bb_vec ,vector<char *> &insn_pool){
...
#define ACC_VGPR 8
    ...
    for ( auto & b : bb_vec) {
       pro_temp.clear(); 
       epi_temp.clear();
       set_getreg_pro_ep(pro_temp,epi_temp,b.acc_sgpr,32,0,7,insn_pool);
...
int main(int argc, char **argv){
    ...
    test_getreg(fp,vec_bb,insn_pool);
